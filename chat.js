...
function getHardResponse(userText) {
    ...
    if(botResponse=="I am very happy seeing you be a happy one."){
        let options2 =['<p class="botText"><span> Lets hear something to complement your feeling right now. What is your mood right now to listen to?</span></p><p class="botText" onmousemove="showOpt2()"></p>']
        for (let index = 0; index < options2.length; index++) {
            $("#chatbox").append(options2[index]);
            document.getElementById("chat-bar-bottom").scrollIntoView(true);
        }
